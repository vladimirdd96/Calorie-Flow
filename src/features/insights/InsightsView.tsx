  ...
  return (
    <main className="page">
      ...
      <div className="workspace-tabs" role="tablist" aria-label="Insights workspace">
        ...
        {weightTrackingEnabled && <button id="insights-weight-tab" type="button" role="tab" aria-selected={section === "weight"} aria-controls="insights-weight-panel" className={section === "weight" ? "active" : ""} onClick={() => setSection("weight")}>Weight history <span>{entries.length}</span></button>}
      </div>
