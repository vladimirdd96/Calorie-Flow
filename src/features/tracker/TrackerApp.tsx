...
export function TrackerApp() {
  ...
  const { restartOnboarding, finishOnboarding, cancelOnboarding, logMeal, saveFood, saveEditedMeal, saveEditedRecipe, dropMeal, duplicateMeal, saveNewMeal, packageRecipe, logCoachMeal, addPhotoMeal, deleteMeal, undoDeleteMeal, exportBackup, restoreBackup, openAdd, selectFood } = actions;
  ...
  return (
    <div className="app-shell">
      ...
      {detailMeal && <Sheet onClose={() => setDetailMeal(undefined)} wide label={`Nutrition details for ${detailMeal.name}`}><NutritionDetails meal={detailMeal} recipe={profile.recipes?.find((recipe) => recipe.id === detailMeal.recipeId)} hideCalories={profile.hideCalories} /></Sheet>}
