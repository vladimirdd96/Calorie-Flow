...
export function TrackerApp() {
  ...
  const actions = useTrackerActions({ auth, profile, foods, meals, dateKey, onboardingOrigin, undoMeal, setFoods, setMeals, setOnboardingOrigin, setUndoMeal, setAdding, setDirectFood, setInitialMealType, setInitialAddView, setDateKey, setToast, setTab, setEditingMeal, setDuplicateMealDraft, saveProfile, syncWrite, markSyncMutation, refresh });
  ...
  const modalOpen = adding || !!foodDetails || !!editingFood || !!editingMeal || !!detailMeal || !!imageMeal || !!duplicateMealDraft || !!moveMealDraft || !!recipeToLog || calendarOpen || nutritionDetailsOpen || !profile.onboardingDone || measurementPromptOpen || weightPromptOpen;
  return (
