...
export function TrackerApp() {
  ...
  return (
    <div className="app-shell">
      ...
      {recipeToLog && <Sheet onClose={() => setRecipeToLog(undefined)} label={`Log ${recipeToLog.name}`} wide><RecipeLogSheet recipe={recipeToLog} foods={foods} meals={meals} onSaveFood={saveFood} onLog={saveNewMeal} onClose={() => setRecipeToLog(undefined)} /></Sheet>}
