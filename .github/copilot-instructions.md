...
- Never use a personal Google or Supabase account for agent work. Read `docs/agent-auth.md` and use the dedicated hosted staging account for local visual checks before pushing UI changes; do not add visual checks to CI.
