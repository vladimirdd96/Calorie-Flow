...
function meal(partial) {
  return { amount: 1, unit: "serving", grams: 200, createdAt: `${dateKey}T08:00:00.000Z`, loggedDate: dateKey, source: "seed", ...partial };
}
export const PROFILE = {
  name: "Alex", sex: "female", age: 32, heightCm: 168, weightKg: 63, activity: "moderate",
  goalMode: "lose", dietPreset: "balanced", calorieTarget: 1850, proteinTarget: 130, carbsTarget: 180,
  fatTarget: 60, fiberTarget: 28, hideCalories: false, onboardingDone: true, carbDisplay: "total",
  planEnabled: true, recipes: [], measurementSystem: "metric",
};
...
export const FOODS = [
  { id: "f1", name: "Grilled chicken breast", servingGrams: 150, servingLabel: "1 breast", nutrientsPer100: { calories: 165, protein: 31, carbs: 0, fat: 3.6, fiber: 0, sugar: 0 }, source: "seed", verified: true },
...
export const RECIPES = [
  {
    id: "r1", name: "Chicken & rice bowl", servings: 2,
    ingredients: [
    ...
    createdAt: `${dateKey}T10:00:00.000Z`, updatedAt: `${dateKey}T10:00:00.000Z`,
  },
];
